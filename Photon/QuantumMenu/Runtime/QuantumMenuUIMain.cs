namespace Quantum.Menu {
  ...
  public partial class QuantumMenuUIMain : QuantumMenuUIScreen {
    ...
    [SerializeField] protected GameObject _kartSelector;
    ...
    public override void Awake() {
      ...
      // works on all platforms, but mobile and WebGL games should consider what behaviour is best
    ...
    protected virtual void OnCharacterButtonPressed() {
      _kartSelector.gameObject.SetActive(!_kartSelector.gameObject.activeSelf);
    }
